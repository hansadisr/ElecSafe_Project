...
if 6 <= current_hour < 18:
    model_path = "/home/pi/yolo/best_train.pt"  # Day model
    print("Using DAY model")
else:
    model_path = "/home/pi/yolo/best.pt"  # Night model
    ...
    while True:
        ...
        if detection_confirmed >= FRAMES_TO_CONFIRM and not elephant_present:
            ...
            if current_time - last_alert_time > COOLDOWN_TIME:
                send_telegram_alert("🚂🚨 TRAIN ALERT: Elephant detected near railway!")
                last_alert_time = current_time
                print("ALERT: Elephant detected near railway!")
        ...
        if detection_confirmed == 0 and elephant_present:
            ...
            if current_time - last_alert_time > COOLDOWN_TIME:
                send_telegram_alert("🚂✅ Train area clear - Elephant left.")
                last_alert_time = current_time
                print("INFO: Train area clear - Elephant left.")
...
if __name__ == "__main__":
    ...
    print("Access status at: http://<raspberry-pi-ip>:5000/status")
